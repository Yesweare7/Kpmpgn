...
function switchForm(type) {
 ...
 function openDetail(item) {
    ...
    if (item.phone) {
        content += `<br><strong>📞 Phone:</strong> <a href="tel:${item.phone}">${item.phone}</a>`;
    }
    if (item.email) {
...

{
  ...
  // 6. NEWS
  const news = [
    { name: "Masantol villages under water", image: "https://www.manilatimes.net/manilatimes/uploads/images/2025/11/10/820377.jpg", description: "At least 39 villages in Masantol and Macabebe, Pampanga are submerged in floodwaters due to high tide and poor drainage, prompting evacuations and suspension of classes. Vice Governor Dennis Pineda confirmed that over 1,700 families were relocated, while officials called for urgent flood control systems and desilting of the Pampanga River. Despite the impact of Super Typhoon Uwan, no injuries were reported in the province.", link: "https://www.msn.com/en-ph/news/world/masantol-macabebe-villages-under-water/ar-AA1Q9UO0?ocid=BingNewsVerpr" },
    { name: "Mayor suspended for 90 days", image: "https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AA1Q3ES2.img?w=686&h=392&m=4&q=89", description: "San Simon Mayor Abundio Punsalan Jr. has been suspended for 90 days over extortion charges filed by RealSteel Corp. The Sandiganbayan ordered the suspension after Punsalan allegedly demanded ₱125 million in exchange for not revoking the company’s business permit and tax incentives. He was arrested in a sting operation after receiving ₱30 million, and now faces charges under the Anti-Graft and Corrupt Practices Act and the Revised Penal Code.", link: "https://www.msn.com/en-ph/news/national/pampanga-town-mayor-suspended-for-90-days/ar-AA1Q3AbT?ocid=BingNewsVerp" },
